...
const publications = defineCollection({
  ...
  schema: z.object({
    ...
    // Research tags — topic AREAS (drive the Research page) plus cross-cutting
    // facets. One field; a paper may carry several. The vocabulary is mirrored
    // in src/lib/content.ts — keep the two in sync when you edit it.
    areas: z
      .array(
        z.enum([
          "heat-exchangers-am",
...
export const collections = { people, publications, gallery };
